...
exports.OverflowProtectedCalculator = exports.CandidateLimiter = exports.HIGH_DIMENSION_THRESHOLD = exports.CANDIDATE_LIMIT = exports.DEFAULT_FILE_SEED = exports.HAMMING_THRESHOLD = exports.UINT64_MASK = void 0;
...
/** 默认文件级种子 */
exports.DEFAULT_FILE_SEED = 0x20250221;
/** 候选集大小硬限制 - MATH-001核心参数 */
exports.CANDIDATE_LIMIT = 100;
/** 高维向量阈值 - 超过此值启用限制 */
exports.HIGH_DIMENSION_THRESHOLD = 768;
/**
...
class CandidateLimiter {
    constructor(limit = exports.CANDIDATE_LIMIT, highDimThreshold = exports.HIGH_DIMENSION_THRESHOLD) {
        this.limit = limit;
     ...
     * 因此需要硬限制防止最坏情况
     */
    calculateCollisionProbability(dimensions, threshold) {
        let combinations = 0;
...
exports.CandidateLimiter = CandidateLimiter;
/**
 * MATH-001: 溢出保护计算器
 *
 * 防止高维场景下的数值溢出
 */
class OverflowProtectedCalculator {
    constructor() {
...
exports.OverflowProtectedCalculator = OverflowProtectedCalculator;
/**
 * 默认导出
 */
exports.default = {
    ...
    CANDIDATE_LIMIT: exports.CANDIDATE_LIMIT,
    HIGH_DIMENSION_THRESHOLD: exports.HIGH_DIMENSION_THRESHOLD,
};
//# sourceMappingURL=simhash-math.js.map