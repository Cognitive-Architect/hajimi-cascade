...
exports.UniversalDetector = exports.MAX_DETECT_BYTES = exports.CONFIDENCE_THRESHOLDS = exports.JSON_START_CHARS = exports.UTF16_BOM_LE = exports.UTF16_BOM_BE = exports.UTF8_BOM_BE = exports.UTF8_BOM_LE = exports.HCTX_MAGIC_BE_V2 = exports.HCTX_MAGIC_LE_V1 = void 0;
exports.detectFormat = detectFormat;
exports.detectFormatFast = detectFormatFast;
...
exports.HCTX_MAGIC_LE_V1 = 0x48535458;
/** HCTX v2.6 BE 格式魔数 ('HCX2' = 0x48435832) */
exports.HCTX_MAGIC_BE_V2 = 0x48435832;
/** UTF-8 BOM (Little Endian) */
exports.UTF8_BOM_LE = Buffer.from([0xEF, 0xBB, 0xBF]);
/** UTF-8 BOM (Big Endian - 实际上UTF-8没有BE BOM，但保留兼容性) */
exports.UTF8_BOM_BE = Buffer.from([0xBF, 0xBB, 0xEF]);
/** UTF-16 BE BOM */
exports.UTF16_BOM_BE = Buffer.from([0xFE, 0xFF]);
/** UTF-16 LE BOM */
exports.UTF16_BOM_LE = Buffer.from([0xFF, 0xFE]);
/** JSON 起始字符 */
exports.JSON_START_CHARS = ['{', '[', '"'];
/** 置信度阈值 */
...
class UniversalDetector {
    ...
    detect(buffer) {
        ...
        if (hctxResult.confidence >= exports.CONFIDENCE_THRESHOLDS.HIGH) {
            return hctxResult;
        }
        // 2. 检测 JSON 格式
        const jsonResult = this.detectJSON(buffer);
        if (jsonResult.confidence >= exports.CONFIDENCE_THRESHOLDS.HIGH) {
            return jsonResult;
        }
        // 3. 检测 Binary 格式
        const binaryResult = this.detectBinary(buffer);
        if (binaryResult.confidence >= exports.CONFIDENCE_THRESHOLDS.MEDIUM) {
            return binaryResult;
        }
        // 4. 综合结果
    ...
    detectHCTX(buffer) {
        ...
        // 直接匹配 BE 魔数
        else if (magicBE === exports.HCTX_MAGIC_BE_V2) {
            byteOrder = 'BE';
            confidence = 0.95;
        }
        // 交叉匹配：BE 读取得到 LE 魔数
        else if (magicBE === exports.HCTX_MAGIC_LE_V1) {
            byteOrder = 'LE';
            confidence = 0.85;
        }
        // 交叉匹配：LE 读取得到 BE 魔数
        else if (magicLE === exports.HCTX_MAGIC_BE_V2) {
            byteOrder = 'BE';
            confidence = 0.85;
        }
        // 未知魔数
    ...
    detectJSON(buffer) {
        ...
        // 限制检测字节数（性能优化）
        const detectBytes = Math.min(buffer.length, exports.MAX_DETECT_BYTES);
        ...
        try {
            ...
            if (encoding === 'utf16be') {
                ...
                // UTF-8 或 UTF-16 LE
                content = sample.toString(encoding, offset);
            }
            // 去除前导空白
            ...
            const isJSONStart = exports.JSON_START_CHARS.includes(firstChar);
            if (!isJSONStart) {
                return {
                    format: 'UNKNOWN',
                    byteOrder: 'N/A',
            ...
            return {
                ...
                byteOrder: 'N/A',
                confidence: 0.1,
                error: `Decode error: ${decodeError.message}`,
    ...
    detectBinary(buffer) {
        ...
        const isBinary = (nullRatio > 0.01 || // 包含空字节
 ...
 * @returns 格式类型
 */
function detectFormatFast(buffer) {
    const detector = new UniversalDetector();
